...
def test_domain_package_only_imports_stdlib_or_relative_domain_modules():
    ...
    allowed_relative_by_module = {
        "__init__": {"accounting", "calibration", "candidate", "comparison", "content", "decision", "degradation", "encoding", "errors", "evidence_report", "exit_protection", "experiment", "fencing", "identity", "kill_switch", "legacy_inventory", "market", "numeric", "policy", "policy_isolation", "portfolio_allocation", "promotion", "recovery", "replay", "risk_governor", "safety_state", "simulator", "trial_ledger"},
