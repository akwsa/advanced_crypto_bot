...
def test_domain_package_only_imports_stdlib_or_relative_domain_modules():
    ...
    allowed_relative_by_module = {
        "__init__": {"accounting", "calibration", "candidate", "content", "decision", "encoding", "errors", "exit_protection", "fencing", "identity", "market", "numeric", "policy", "portfolio_allocation", "recovery", "replay", "risk_governor", "safety_state", "simulator"},
