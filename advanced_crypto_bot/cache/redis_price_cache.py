# Tujuan: Cache harga Redis dengan fallback local memory.
# Caller: bot.py, price poller, scalper, signal pipeline.
# Dependensi: Redis client optional, time, threading lock.
# Main Functions: price_cache; RedisPriceCache.
# Side Effects: Redis read/write; in-memory cache mutation.
"""
