# Tujuan: State manager posisi/pair/scalper dengan Redis fallback file/memory.
# Caller: bot.py, scalper, runtime modules.
# Dependensi: Redis optional, JSON file fallback.
# Main Functions: state_manager; RedisStateManager.
# Side Effects: Redis read/write, file I/O fallback, in-memory mutation.
"""
