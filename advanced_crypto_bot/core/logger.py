# Tujuan: Konfigurasi logging aplikasi yang konsisten.
# Caller: bot.py dan modul runtime lain.
# Dependensi: logging stdlib, filesystem log directory.
# Main Functions: class CustomLogger.
# Side Effects: File I/O log, stdout/stderr logging.
import logging
import os
