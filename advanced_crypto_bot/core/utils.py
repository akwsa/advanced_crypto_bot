# Tujuan: Utility formatting, pair parsing, PnL, dan helper waktu.
# Caller: bot.py, formatter, scalper, trading modules.
# Dependensi: Config, pandas/numpy optional utility context.
# Main Functions: class Utils.
# Side Effects: File I/O JSON helper; no network.
import os
import json
import pandas as pd
import numpy as np
