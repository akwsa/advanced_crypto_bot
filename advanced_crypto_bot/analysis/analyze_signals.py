# Tujuan: Analisis cepat BUY/SELL untuk command user.
# Caller: bot.py command analysis.
# Dependensi: TechnicalAnalysis, ML models, price data.
# Main Functions: class AnalyzeSignals.
# Side Effects: May trigger data reads via caller; no direct persistent writes.
"""
