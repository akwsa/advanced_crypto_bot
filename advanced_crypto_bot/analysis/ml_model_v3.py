#!/usr/bin/env python3
# Tujuan: Model ML V3 pro dengan backtesting dan risk-aware scoring.
# Caller: bot.py startup dan command retrain/backtest.
# Dependensi: scikit-learn/joblib, pandas/numpy.
# Main Functions: class MLTradingModelV3; create_model.
# Side Effects: File I/O model/report; CPU-heavy training/backtest.
"""
...
class MLTradingModelV3:
    ...
    def train(self, df, use_multi_class=True):
        ...
        threshold_end_idx = int(len(df) * 0.8)
        targets = self.prepare_targets(df, threshold_end_idx=threshold_end_idx)
