# Tujuan: Model ML V1 untuk prediksi trading dan retraining dasar.
# Caller: bot.py, trading engine, signal pipeline fallback.
# Dependensi: scikit-learn/joblib, pandas/numpy, model files.
# Main Functions: class MLTradingModel.
...
class MLTradingModel:
    ...
    def create_model(self):
        """Create ensemble model with class balancing to fix SELL bias"""
        self.model = {
            'rf': RandomForestClassifier(
                ...
                class_weight='balanced'  # FIX: Counteract SELL bias
            ),
    ...
    def predict(self, df):
        ...
        try:
            ...
            # FIX: Widen BUY zone (0.55+) and narrow SELL zone (< 0.45)
            # to counteract SELL bias from imbalanced training data
            if prediction >= 0.55:
                signal_class = 'BUY'
