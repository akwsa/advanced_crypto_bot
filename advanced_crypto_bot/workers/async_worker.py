# Tujuan: Worker async background untuk offload job runtime.
# Caller: bot.py startup/shutdown.
# Dependensi: asyncio, threading/queue primitives.
# Main Functions: class BackgroundWorker.
# Side Effects: Background thread/task lifecycle.
"""
